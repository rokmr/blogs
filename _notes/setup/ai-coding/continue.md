...
[Continue](https://github.com/continuedev/continue) is a highly customizable, open-source AI assistant for VS Code and JetBrains. Unlike proprietary copilots, Continue allows you to easily plug in any local (Ollama) or remote (OpenAI, Anthropic) models.
